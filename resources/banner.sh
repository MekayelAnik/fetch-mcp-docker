...
print_ascii_art() {
    ...
    printf "${NAVY_BLUE}  /SSSSSSSS          /SS               /SS          ${NC} \n"
    printf "${NAVY_BLUE} | SS_____/         | SS              | SS          ${NC} \n"
    printf "${NAVY_BLUE} | SS     /SSSSSS  /SSSSSS    /SSSSSSS| SSSSSSS     ${NC} \n"
    printf "${NAVY_BLUE} | SSSSS /SS__  SS|_  SS_/   /SS_____/| SS__  SS    ${NC} \n"
    printf "${NAVY_BLUE} | SS__/| SSSSSSSS  | SS    | SS      | SS  \ SS    ${NC} \n"
    printf "${NAVY_BLUE} | SS   | SS_____/  | SS /SS| SS      | SS  | SS    ${NC} \n"
    printf "${NAVY_BLUE} | SS   |  SSSSSSS  |  SSSS/|  SSSSSSS| SS  | SS    ${NC} \n"
    printf "${NAVY_BLUE} |__/    \_______/   \___/   \_______/|__/  |__/    ${NC} \n"
